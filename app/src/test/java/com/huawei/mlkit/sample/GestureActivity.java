...
public final class GestureActivity extends AppCompatActivity
    ...
    private void createDialog() {
        ...
        final Intent intent = new Intent(com.huawei.mlkit.sample.activity.getsture.GestureActivity.this, GestureImageActivity.class);
        ...
        this.addPictureDialog.setClickListener(new AddPictureDialog.ClickListener() {
            ...
            public void takePicture() {
                ...
                preview.stop();
                com.huawei.mlkit.sample.activity.getsture.GestureActivity.this.startActivity(intent);
            }
