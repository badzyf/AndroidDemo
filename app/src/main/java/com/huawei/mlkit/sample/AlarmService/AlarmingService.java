package com.huawei.mlkit.sample.AlarmService;
...
public class AlarmingService extends AppCompatActivity implements View.OnClickListener {
    ...
    private int cycle;
    private int ring;
    private TextView title_id;     //toolbar的title单独用 text view来设置。
    private Toolbar tb_remind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pvTime = new com.bigkoo.pickerview.TimePickerView(this, com.bigkoo.pickerview.TimePickerView.Type.HOURS_MINS);
            ...
            if (cycle == -1) {//是只响一次的闹钟
                ...
                for (int i = 0; i < weeks.length; i++) {
                    AlarmManagerUtil.setAlarm(this, 2, Integer.parseInt(times[0]), Integer
                            .parseInt(times[1]), i, Integer.parseInt(weeks[i]), "继续训练！不要放弃！", ring);
                }
            }
    ...
    public void InitBar() {
        tb_remind = findViewById(R.id.tb_remind);
        tb_remind.setTitleTextColor(Color.WHITE);
        tb_remind.setNavigationIcon(R.mipmap.back);
        tb_remind.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
